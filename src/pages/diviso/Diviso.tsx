...
export default function Diviso() {
  const PRIMARY_COLOR = "#059669"; // Verde esmeralda copado para apps de finanzas/gastos
  ...
  useEffect(() => {
    ...
    if (link) {
      link.href = "/images/diviso/logo_diviso.png";
    }
  }, []);
  ...
  return (
    <div className={`bg-[#f2f5f6] text-slate-800 font-sans min-h-screen overflow-x-hidden`} style={{ '--primary-color': PRIMARY_COLOR } as React.CSSProperties}>
      ...
      <AppNavbar 
        appName="Diviso"
        logoSrc="/images/diviso/logo_diviso.png"
        primaryColor={PRIMARY_COLOR}
        downloadUrl="https://play.google.com/store/apps/details?id=com.ymprojects.dividirgastos" // Ajustado (esperando confirmación del link final)
        navLinks={[
      ...
      <AppHero 
        ...
        gradientEnd="#e6f6f0"
        secondaryActionText=""
        downloadUrl="https://play.google.com/store/apps/details?id=com.ymprojects.dividirgastos"
      />
