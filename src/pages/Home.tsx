                ...
                >
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-2/5 p-8 lg:p-16 flex flex-col justify-center">
                      <span className="text-primary font-bold tracking-widest uppercase text-[10px] mb-4">{project.category}</span>
                      <h3 className="text-3xl lg:text-4xl font-bold mb-6">{project.title}</h3>
                      <p className="text-on-surface-variant text-lg mb-8 leading-relaxed">{project.description}</p>
                      <div className="flex flex-wrap gap-2 mb-10">
                        {project.tags.map(tag => (
                          <span key={tag} className="px-3 py-1 bg-surface-container-low rounded-full text-[10px] font-semibold text-on-surface-variant">
                            {tag}
                          </span>
                        ))}
                      </div>
