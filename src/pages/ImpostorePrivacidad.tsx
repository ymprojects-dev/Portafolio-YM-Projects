...
export default function ImpostorePrivacidad() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Políticas de Privacidad - Impostore";
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose max-w-none text-slate-600 bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          ...
          <ul className="list-[square] pl-6 space-y-4 mb-4">
            ...
            <li><span className="underline">Datos de Uso:</span> Información sobre cómo interactúa con la aplicación, frecuencia de uso y preferencias de juego.</li>
          ...
          <p className="mb-4">Impostore App emplea la información con el fin de proporcionar el mejor servicio posible y mejorar la experiencia de usuario. Particularmente para:</p>
          <ul className="list-[square] pl-6 space-y-4 mb-4">
            ...
            <li><span className="underline">Comunicaciones:</span> Es posible que se envíen correos electrónicos periódicamente con actualizaciones del juego, nuevas funcionalidades o información publicitaria que consideremos relevante. Usted puede cancelar estas comunicaciones en cualquier momento.</li>
          </ul>
          ...
          <ul className="list-[square] pl-6 space-y-4 mb-4">
            <li><span className="underline">Reconocer al usuario individualmente</span> y recordar sus preferencias de juego.</li>
          ...
          <ul className="list-square pl-6 space-y-4 mb-4">
            ...
            <li><span className="underline">Derecho de Eliminación:</span> Puede solicitar que eliminemos su registro de usuario y datos asociados. Para ejercer cualquier derecho, puede contactarnos a través del correo electrónico: ym.projects.dev+soporte@gmail.com.</li>
          </ul>
          ...
          <p className="mb-4">Impostore App puede contener enlaces a otros sitios web o aplicaciones que puedan ser de su interés. Una vez que usted haga clic en estos enlaces y abandone nuestra aplicación, no tenemos control sobre el sitio al que es redirigido y, por lo tanto, no somos responsables de los términos o la protección de sus datos en esos sitios terceros.</p>
          ...
          <p className="mb-4">Impostore App se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento. Le recomendamos revisar continuamente este documento dentro de la aplicación o en nuestro sitio oficial para asegurarse de que está de acuerdo con los términos vigentes.</p>
        </div>
